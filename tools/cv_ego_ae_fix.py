...
IQ = Path(r"C:\Users\stefa\Desktop\CameVision Ego\build\live\sc233hgs_efference-sc233hgs_backlight.json")
...
def main() -> int:
    ...
    sh(
        ...
        "v4l2-ctl -d /dev/v4l-subdev10 -c exposure=480 -c analogue_gain=64; "
        "v4l2-ctl -d /dev/v4l-subdev5 -c exposure=480 -c analogue_gain=64; "
    ...
    sh(
        ...
        "echo === hw ===; grep -E 'YNR|ENH|DRC|SHARP' /proc/rkisp-vir0; "
